import { Laptop } from "../../data/Data.js";
...
function createProduct() {
  ...
  for (var i = 0; i < Laptop.length; i++) {
    ...
    link.id = "productLink";
    link.href = "javascript:sendId(" + i.toString() + ",1)";
    var img = document.createElement("img");
    img.className = "card-img-top";
    img.src = "../../data" + Laptop[i].img1;
    img.alt = "...";
    img.style.width = "100%";
    ...
    name.textContent = Laptop[i].title;
    ...
    priceNowValue.textContent = Laptop[i].price;
    ...
    priceBuyValue.textContent = Laptop[i].price;
